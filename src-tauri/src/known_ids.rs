...
known_ids! {
    ...
    gps_latitude_ref => ("GPS::Main", "1"), gps_latitude => ("GPS::Main", "2"),
    gps_longitude_ref => ("GPS::Main", "3"), gps_longitude => ("GPS::Main", "4"),
    gps_altitude_ref => ("GPS::Main", "5"), gps_altitude => ("GPS::Main", "6"),
    ...
    xmp_location_created => ("XMP::iptcExt", "LocationCreated"),
...
pub fn test_id(label: &str) -> SchemaDefinitionId {
    match label {
        ...
        "ExifIFD:DateTimeOriginal" => date_time_original(),
        "ExifIFD:CreateDate" => create_date(),
        "XMP-dc:Description" => xmp_description(),
        "XMP-dc:Title" => xmp_title(),
        "XMP-dc:Subject" => xmp_subject(),
        ...
        "XMP-iptcExt:LocationCreated" => xmp_location_created(),
        "XMP-xmp:CreateDate" => xmp_create_date(),
        "IPTC:ObjectName" => iptc_object_name(),
        "IPTC:Keywords" => iptc_keywords(),
        "IPTC:DateCreated" => iptc_date_created(),
        "IPTC:TimeCreated" => iptc_time_created(),
        "IPTC:DigitalCreationDate" => iptc_digital_creation_date(),
        "IPTC:DigitalCreationTime" => iptc_digital_creation_time(),
        "IPTC:By-line" => iptc_by_line(),
        "IPTC:City" => iptc_city(),
        "IPTC:Sub-location" => iptc_sub_location(),
        "IPTC:Province-State" => iptc_province_state(),
        "IPTC:Country-PrimaryLocationCode" => iptc_country_code(),
        "IPTC:Country-PrimaryLocationName" => iptc_country_name(),
        "IPTC:Headline" => iptc_headline(),
        "IPTC:CopyrightNotice" => iptc_copyright(),
        "IPTC:Caption-Abstract" => iptc_caption(),
        "XMP-mlib:AIDescription" => mlib_ai_description(),
        "XMP-mlib:AIInterpretation" => mlib_ai_interpretation(),
        "XMP-mlib:AIObjects" => mlib_ai_objects(),
        "XMP-mlib:AIOcrText" => mlib_ai_ocr_text(),
        "XMP-mlib:AITags" => mlib_ai_tags(),
