...
mod tests {
    ...
    fn location_evidence_is_compacted_and_keeps_ranking_hints() {
        let input = LocationInput {
            geocode_json: Some(
                r#"{"type":"FeatureCollection","licence":"ignored","features":[{"geometry":{"coordinates":[0,0]},"properties":{"geocoding":{"place_id":123,"type":"house","osm_key":"place","osm_value":"house","name":"12 Example Close","label":"12 Example Close, Exampleton, United Kingdom","housenumber":"12","street":"Example Close","city":"Example District","county":"Example County","state":"England","country":"United Kingdom","admin":{"level8":"Exampleton"}}}}]}"#
                    .into(),
            ),
            json_v2: Some(
                r#"{"place_id":456,"licence":"ignored","lat":"0","lon":"0","category":"place","type":"house","addresstype":"place","name":"12 Example Close","place_rank":30,"importance":0.0001,"address":{"house_number":"12","road":"Example Close","village":"Exampleton","county":"Example County","state":"England","ISO3166-2-lvl4":"GB-ENG","country":"United Kingdom","country_code":"gb"},"boundingbox":["0","1","2","3"]}"#
                    .into(),
            ),
            ..Default::default()
        };
        ...
        assert!(prompt.evidence.contains("village: \"Exampleton\""));
        for omitted in [
            "place_id",
            "licence",
            "country_code",
