...
mod model;
pub use model::{
    MetadataApplyFileResult, MetadataApplyResult, MetadataApplyStreamMessage, MetadataApplySummary,
};

// Apply-operation exclusivity, cancellation and worker lifecycle.
mod state;
pub(crate) use state::run_apply_edits_command;
pub use state::{ApplyEditsBusyError, ApplyEditsState};
...
// Draft selection, chunking, reconciliation, persistence and delivery policy.
mod coordinator;
use coordinator::run_apply_metadata_draft_edits_with_limits;
