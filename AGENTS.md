...
- Sourced from real photographs in `D:\Photos` covering varied camera manufacturers and formats.
...
1. Pick a source file from `D:\Photos` (or any image with the metadata shape you want to test).
