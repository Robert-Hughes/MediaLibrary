 ...
 */
export type ImageMetadata = { relative_path: string, metadata: { [key in string]?: Variant }, raw_metadata: { [key in string]?: Variant }, metadata_values: { [key in string]?: MetadataValue }, raw_metadata_values: { [key in string]?: MetadataValue }, };
