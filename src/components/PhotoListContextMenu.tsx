...
export function PhotoListContextMenu({
  x, y, contextMenuIndex, selectedIndices, photos, draftEdits,
  onPhotoOpen, onShowInExplorer, onCopyPaths,
  onGenerateAiDescription, onGeocode, onNormalise,
  onApplyEdits, onDiscardAllEdits,
  onClose,
}: Props) {
