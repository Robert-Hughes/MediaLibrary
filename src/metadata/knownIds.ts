...
export const KNOWN_METADATA_IDS = {
  ...
  xmpHeadline: id("XMP::fileshop", "Headline"),
  xmpCity: id("XMP::fileshop", "City"),
  xmpState: id("XMP::fileshop", "State"),
  xmpCountry: id("XMP::fileshop", "Country"),
  xmpDateCreated: id("XMP::fileshop", "DateCreated"),
...
> = [
  ...
  [KNOWN_METADATA_IDS.xmpHeadline, "XMP-fileshop", "Headline"],
  [KNOWN_METADATA_IDS.xmpCity, "XMP-fileshop", "City"],
  [KNOWN_METADATA_IDS.xmpState, "XMP-fileshop", "State"],
  [KNOWN_METADATA_IDS.xmpCountry, "XMP-fileshop", "Country"],
  [KNOWN_METADATA_IDS.xmpDateCreated, "XMP-fileshop", "DateCreated"],
