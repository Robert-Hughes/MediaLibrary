...
export type SearchWorkerInbound =
  ...
  | { type: "INIT_META"; entries: Array<{ path: string; meta: ImageMetadataState }> }
  | { type: "INIT_DRAFTS"; entries: Array<{ path: string; edits: Record<string, DraftEdit> }> }
  | { type: "UPSERT_PHOTO"; photo: SearchPhotoFields }
  | { type: "UPSERT_META"; path: string; meta: ImageMetadataState }
  | { type: "UPSERT_DRAFTS"; path: string; edits: Record<string, DraftEdit> | undefined }
