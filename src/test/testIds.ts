...
const known: Record<string, SchemaDefinitionId> = {
  ...
  "XMP-fileshop:Headline": ID.xmpHeadline,
  "XMP-fileshop:City": ID.xmpCity,
  "XMP-fileshop:State": ID.xmpState,
  "XMP-fileshop:Country": ID.xmpCountry,
  "XMP-fileshop:DateCreated": ID.xmpDateCreated,
