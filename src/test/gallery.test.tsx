...
describe("PhotoList interaction", () => {
  function renderList(photos: PhotoInfo[], onPhotoOpen: (i: number) => void, onSelect: (i: number | null) => void) {
    ...
    render(<PhotoList photos={photos} thumbnails={thumbs} imageMetadata={imageMetadata} visibleColumns={[]} visibleOSColumns={["date_modified", "date_created"]} selectedIndex={null} onSelect={onSelect} onShowInExplorer={() => {}} onVisibilityChange={() => {}} onPhotoOpen={onPhotoOpen} />);
  }
