...
* I ran reverse geocoding on "D:\Photos\2008\IMG_7459.jpg", see the results in the saved drafts for this folder. The IPTC:Sub-location changed from the old value of Clifton Moor to Oakdale Road. I think the old value would have come from the Update Metadata Scripts reverse-geocoding approach (which our implementation is based on) so I'm curious why our implementation
...
Similarly, for "D:\Photos\2010\Image0009.jpg" the old Sub-location had "Foss Islands" in it (as well as the pub name), but the new result just has the pub name. Why different?
