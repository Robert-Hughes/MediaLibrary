...
21. **Check destination occupancy.** With a proven existing IFD0 selector, confirm the exact IFD0/family-7/name destination is blocked while a distinct IFD1 selector is allowed. With a same-schema occurrence lacking an exact target, confirm creation remains conservatively blocked.
